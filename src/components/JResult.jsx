        ...
        <div className="w-full">
            ...
            <div className="w-11/12 mx-auto  my-5" >
                ...
                <div className="w-full flex justify-center">
                    <Link to={'/'}><button className="btn px-3 bg-green-500 font-bold text-xl"></button></Link>
                </div>
                    <div className="p-3">
                        <h2> Next1NoNO</h2>
                        {
                    ...
                    <div className="w-full flex justify-center">
                        <Link to={'/result/5'}><button className="btn px-3 bg-green-500 font-bold text-xl">Result</button></Link>
                    </div>
                </div>

            ...
            <div className="w-11/12 mx-auto  my-5" >
                ...
                <div className="w-full flex justify-center">
                    ...
                    <div className="w-full flex justify-between">
                        <Link to={'/Next2YesNoNo'}><button className="btn px-3 bg-green-500 font-bold text-xl">No</button></Link>
                        <Link to={'/result/7'}><button className="btn px-3 bg-green-500 font-bold text-xl">Yes</button></Link>
                    </div>
                </div>
